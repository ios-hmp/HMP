...
- (void)viewDidLoad {
    ...
    classVCNameArr = @[@"CBMarryMessageVC",@"CBMarryMessageVC",@"CBMarryMessageVC",@"CBPhotoListVC",@"CBMarryMessageVC",@"CBBlacklistVC",@"CBComplaintVC",@"CBMarryMessageVC",@"CBAccountSettingVC",];
