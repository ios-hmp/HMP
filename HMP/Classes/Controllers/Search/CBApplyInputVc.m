...
-(void)sendContent{
    if ([_field.text hasPrefix:orgTxt]) {
        [LoadingView showAMessage:orgTxt];
        return;
    }
    NSString *url = @"friends/index/upgrade";
    [CBBaseModel request:url par:@{@"uid":self.applyInfo[@"id"]?:@"",@"req_message":_field.text} callback:^(id  _Nonnull data, NSString * _Nonnull msg) {
