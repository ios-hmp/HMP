...
- (void)viewDidLoad {
    ...
    classVCNameArr = @[@"CBMarryMessageVC",@"CBRequireVC",@"CBMarryMessageVC",@"CBPhotoListVC",@"CBMarryMessageVC",@"CBBlacklistVC",@"CBComplaintVC",@"CBMarryMessageVC",@"CBAccountSettingVC",];
